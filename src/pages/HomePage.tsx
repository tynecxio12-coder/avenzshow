...
import { ArrowRight, Truck, Shield, RotateCcw, Headphones, Star, ChevronRight } from 'lucide-react';
    ...
    <Layout>
      ...
      <section className="section-padding py-16 bg-secondary/50">
        <div className="flex items-end justify-between mb-10">
          ...
          <Link to="/shop?filter=trending" className="hidden sm:flex items-center gap-2 text-sm font-semibold uppercase tracking-wide hover:text-gold transition-colors">
      ...
      <section className="section-padding py-16">
        <div className="relative rounded-2xl overflow-hidden bg-primary">
          <div className="absolute inset-0 opacity-20">
            <img src="https://images.unsplash.com/photo-1556906781-9a412961c28c?w=1200" alt="" className="w-full h-full object-cover" />
          </div>
          <div className="relative px-8 py-16 md:py-20 text-center">
            <span className="text-gold text-sm uppercase tracking-[0.3em] font-semibold">Limited Time Only</span>
            ...
            <Link to="/shop?filter=sale" className="inline-block mt-8 px-10 py-4 gold-gradient text-primary font-semibold uppercase text-sm tracking-widest rounded-lg hover:opacity-90 transition-opacity">
              Shop the Sale
            </Link>
          </div>
        </div>
      ...
      <section className="section-padding py-16">
        <div className="flex items-end justify-between mb-10">
          ...
          <Link to="/shop?filter=new" className="hidden sm:flex items-center gap-2 text-sm font-semibold uppercase tracking-wide hover:text-gold transition-colors">
            View All <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
      ...
      <section className="section-padding py-16 bg-secondary/50">
        <div className="flex items-end justify-between mb-10">
          ...
          <Link to="/shop?filter=bestseller" className="hidden sm:flex items-center gap-2 text-sm font-semibold uppercase tracking-wide hover:text-gold transition-colors">
            View All <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
