  ...
  return (
    <>
      <div className="bg-primary text-primary-foreground text-xs py-2 text-center tracking-widest font-body uppercase">
        Free shipping on orders over ৳5,000 | Use code{' '}
        <span className="text-gold font-semibold">AVENZ20</span> for 20% off
      </div>
            ...
            <nav className="section-padding py-4 space-y-1">
              {navLinks.map((link) => (
                <div key={link.label}>
                  <Link
                    to={link.path}
                    className="block py-3 text-sm font-medium uppercase tracking-wide hover:text-gold transition-colors"
                  >
                    {link.label}
                  </Link>
              ...
              <div className="flex gap-4 pt-4 border-t border-border">
                ...
                {user ? (
                  <Link to="/account" className="flex items-center gap-2 text-sm hover:text-gold">
